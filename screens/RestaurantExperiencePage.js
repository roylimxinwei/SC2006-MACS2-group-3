...
/**
 * A component for setting user preferences related to restaurant experiences.
 * Allows the user to set preferences for restaurant ratings, proximity, and operation status.
 */
const RestaurantExperience = () => {
	...
	/**
	 * Toggles the state of the switch that controls whether to show only open restaurants.
	 */
	const toggleSwitch = () => setIsEnabled(previousState => !previousState);

	/**
	 * Saves the user's preferences to Firestore and navigates back to the HomeScreen.
	 */
