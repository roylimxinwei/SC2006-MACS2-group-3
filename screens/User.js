...
/**
 * A screen where users can view and redeem their loyalty points, and navigate to related features.
 ...
 * @param {Object} props.route - Route object used for passing parameters between components.
 */
const UserScreen = ({ navigation, route }) => {
	...
	/**
	 * Fetches the current user's points from Firestore when the screen is focused.
	 */
	...
	/**
	 * Handles redeeming points. It verifies the points, checks against the user's current points,
	 * updates the database, and alerts the user of the outcome.
	 */
	const redeem = async () => {
