...
/**
 * Component to display and manage parties a user has joined.
...
const Parties = ({ navigation }) => {
	...
	/**
	 * Fetches the parties from Firestore that the current user is a guest in.
	 */
	...
	/**
	 * Removes the current user from a party's guest list and updates the database.
	 * @param {Object} item - The party from which the user will be removed.
	 */
	...
	/**
	 * Calls fetchParties when the component mounts.
	 */
	useEffect(() => {
		fetchParties()
