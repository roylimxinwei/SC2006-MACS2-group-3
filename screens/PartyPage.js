...
/**
 * Screen for managing party details, viewing guests, and splitting costs among them.
...
const PartyPage = ({ navigation }) => {
	...
	/**
	 * Fetches party details including guests and host from Firestore on component mount.
	 */
	useEffect(() => {
	...
	/**
	 * Handles splitting the total cost equally among all guests including the host.
	 */
